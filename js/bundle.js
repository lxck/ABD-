...
/******/ 	var hotCurrentHash = "17ed0ec25612219918b9"; // eslint-disable-line no-unused-vars
...
$('.navBtnSilder').on('click', function() {
	$('.navBtnSilder').toggleClass('animate');
});


$('.disease li').each(function(i){
	$('.disease li').eq(i).click(function(){
		$("html,body").animate({scrollTop:$('#disease').offset().top-$('header').height()},200);
	})
})
